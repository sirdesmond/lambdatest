import logging
from AlexaTensorFlowHandler import AlexaTensorFlowHandler
...
def lambda_handler(event, context):
    logging.info("Executing main lambda_handler for AlexaTensorFlowHandler class")

    alexa = AlexaTensorFlowHandler()
